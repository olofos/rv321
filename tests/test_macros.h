...
#define LABEL_PASTER(x,y) test_ ## x ## _ ## y
#define LABEL(x,y)  LABEL_PASTER(x,y)

#define LABEL_DATA_PASTER(x,y) test_ ## x ## _ ## y ## _data
#define LABEL_DATA(x,y)  LABEL_DATA_PASTER(x,y)

#define LABEL_LINK_ADDR_PASTER(x,y) linkaddr_ ## x ## _ ## y
#define LABEL_LINK_ADDR(x,y)  LABEL_LINK_ADDR_PASTER(x,y)

#define LABEL_TARGET_PASTER(x,y) target_ ## x ## _ ## y
#define LABEL_TARGET(x,y)  LABEL_TARGET_PASTER(x,y)
