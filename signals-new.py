...
signalValues = {
    ...
    # STEP_LEN:       {1: 0,
                    ...
                    # 8:      0b00000000_00000000_00000000_11000000,
                    # },
    LENGTH_FIELD:   {0: 0,
    ...
    MEM_WE:         {0: 0,
                     1:      0b00000000_00010000_00000000_00000000},
    OP_LATCH:       {0: 0,
                     1:      0b00000000_00100000_00000000_00000000},

    ALU_A_MUX:      {'U': 0,
                     'RS1':     0b00000000_00000000_00000000_00000000,
                     'PC':      0b00000001_00000000_00000000_00000000,
                     'Const31': 0b00000010_00000000_00000000_00000000,
                     'Zero':    0b00000011_00000000_00000000_00000000},
    ALU_B_MUX:      {'U': 0,
                     'RS2':    0b00000000_00000000_00000000_00000000,
                     'ImmI':   0b00000100_00000000_00000000_00000000,
                     'ImmS':   0b00001000_00000000_00000000_00000000,
                     'ImmB':   0b00001100_00000000_00000000_00000000,
                     'ImmU':   0b00010000_00000000_00000000_00000000,
                     'ImmJ':   0b00010100_00000000_00000000_00000000,
                     'Const1': 0b00011000_00000000_00000000_00000000,
                     'Zero':   0b00011100_00000000_00000000_00000000},
    REG_IN_MUX:     {'U': 0,
                     'ALU':  0b00000000_00000000_00000000_00000000,
                     'MEM':  0b00100000_00000000_00000000_00000000,
                     'CSR':  0b01000000_00000000_00000000_00000000,
                     'PC':   0b01100000_00000000_00000000_00000000},
}
...
def handleIdentifications(signal):
    ...
    # signal[BUS_EN] = 0 if signal[STEP_LEN] == 1 else 1
    # signal[LENGTH_FIELD] = 3 if (signal[BUS_EN] == 1 and signal[STEP_LEN] == 8) else
...
def setLowerCommon(op):
    ...
    return [
        ...
        { ALU_RESET: 1, ALU_OP: aluOp, ALU_A_MUX: 'RS1', ALU_B_MUX: B,  BUS_EN: 1, STEP_LEN: 8,},
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
...
def setLowerTrue(op):
    return setLowerCommon(op) + [
        { ALU_RESET: 1, ALU_FLAG_LATCH: 0,REG_IN_EN: 0, ALU_A_MUX: 'Zero', ALU_B_MUX: 'Const1', ALU_OP: 'OR', REG_IN_MUX: 'ALU', BUS_EN: 1, STEP_LEN: 8, META_SECTION: op },
...
def setLowerFalse(op):
    return setLowerCommon(op) + [
        { ALU_FLAG_LATCH: 0,REG_IN_EN: 0, ALU_A_MUX: 'Zero', ALU_B_MUX: 'Zero', ALU_OP: 'ADD', REG_IN_MUX: 'ALU', BUS_EN: 1, STEP_LEN: 8, META_SECTION: op },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { REG_IN_EN: 1, ALU_A_MUX: 'U', ALU_B_MUX: 'U', ALU_OP: 'U', REG_IN_MUX: 'U', LAST_STEP: 1, BUS_EN: 0, STEP_LEN: 1 },
...
def branchCommon(op):
    ...
    return [
        ...
        { ALU_RESET: 1, ALU_OP: aluOp, ALU_A_MUX: 'RS1', ALU_B_MUX: 'RS2',  BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
...
def branchNotTaken(op):
    return branchCommon(op) + [
        { ALU_FLAG_LATCH: 0, LAST_STEP: 1, BUS_EN: 0, STEP_LEN: 1, META_SECTION: op + ' [Not taken]' },
        { BUS_EN: 0, STEP_LEN: 1 },
    ]

def branchTaken(op):
    return branchCommon(op) + [
        { ALU_FLAG_LATCH: 0, ALU_RESET: 0, BUS_EN: 0, STEP_LEN: 1, META_SECTION: op + ' [Taken]' },
...
def shiftCommon(op):
    ...
    return [
        { ALU_RESET: 0, ALU_N: n, OP_LATCH: 0, BUS_EN: 0, STEP_LEN: 1, META_SECTION: op},
        { ALU_RESET: 1, ALU_OP: aluOp, ALU_A_MUX: 'Const31', ALU_B_MUX: B, BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8, ALU_A_MUX: 'Zero' },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { ALU_N: 0, ALU_A_MUX: 'U', ALU_B_MUX: 'U', BUS_EN: 0, STEP_LEN: 1 },
        { ALU_A_MUX: 'RS1', ALU_B_MUX: 'U', BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { ALU_A_MUX: 'U', REG_IN_EN: 0, REG_IN_MUX: 'ALU', BUS_EN: 1, STEP_LEN: 8 } ,
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
        { BUS_EN: 1, STEP_LEN: 8 },
