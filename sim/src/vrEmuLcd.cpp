...
/* font roms */
extern const byte fontA00[ROM_FONT_CHARS][CHAR_WIDTH_PX];
extern const byte fontA02[ROM_FONT_CHARS][CHAR_WIDTH_PX];
...
const byte fontA00[ROM_FONT_CHARS][CHAR_WIDTH_PX] = {
...
// skip first 16 characters reserved for CGRAM
const byte fontA02[ROM_FONT_CHARS][CHAR_WIDTH_PX] = {
